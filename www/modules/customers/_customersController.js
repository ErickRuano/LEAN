...
//                    '</md-input-container>'+
            ...
            validate : function(callback){
                ...
                $http.get('/product/1/user/'+form.email).then(function(data){
                    alert(data.data)
                    if(data.data == 200){ // lo encontró
                        error.count ++;
                        available ++;
                        error.message = error.message + '<p>Este email ya está registrado.</ p>';
                    }
                    if(available == 2){
                        returnValidate();           
                    }
                ...
                $http.get('/product/2/user/'+form.email).then(function(data){
                    alert(data.data)
                    if(data.data == 200){
                        error.count ++;
                        error.message = error.message + '<p>Este email ya está registrado.</ p>';
